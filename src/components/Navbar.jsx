...
import { logoBlack, logoColor, logoNoBackground, logoWhite, menu, close } from "../assets"
...
const Navbar = () => {
  ...
  return (
    <nav
      className={`
        ${styles.paddingX} w-full flec items-center py-5 fixed top-0 z-20 bg-primary
      `}
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        {/* phần này khi screen hẹp lại tạo hiệu ứng thu gọn thành menu ẩn */}
